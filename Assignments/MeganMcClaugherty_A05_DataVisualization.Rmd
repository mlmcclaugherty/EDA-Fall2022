...
A5Q4plot<-ggplot(LakeChemNutrient, aes(x=tp_ug, y=po4, color=lakename))+
  geom_point()+
...
LakeTempbyMonth<-ggplot(LakeChemNutrient, aes(x= as.factor(month), y=temperature_C, color = lakename))+
  geom_boxplot()+
  xlab("Month")
print(A5Q5Temp)
LakeTPbyMonth<-ggplot(LakeChemNutrient, aes(x= as.factor(month), y=tp_ug, color = lakename))+
  geom_boxplot()+
  xlab("Month")
print(A5Q5TP)
LakeTNbyMonth<-ggplot(LakeChemNutrient, aes(x = as.factor(month), y=tn_ug, color = lakename))+
  geom_boxplot()+
  xlab("Month")
print(A5Q5TN)


LakeTempTPTNbyMonth<-plot_grid(LakeTempbyMonth, LakeTPbyMonth, LakeTNbyMonth, nrow = 3, align = 'h', rel_heights = c(3, 3, 3))
...
```{r}
#6 
A5Q6needlemass<-ggplot(subset(LitterMassTrap, functionalGroup == "Needles"),
                       aes(x = collectDate, y = dryMass, color = nlcdClass))+
                         geom_point()
print(A5Q6needlemass)


#7
A5Q7<-ggplot(subset(LitterMassTrap, functionalGroup == "Needles"), 
