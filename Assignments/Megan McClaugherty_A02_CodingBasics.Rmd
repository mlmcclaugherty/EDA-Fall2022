...
> Answer: ifelse worked. It worked because the function allows you to create logical condition, then runs the following two codes after evaluating the vector.
