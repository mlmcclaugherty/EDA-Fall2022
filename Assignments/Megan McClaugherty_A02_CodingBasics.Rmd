...
#2. Here I use the mean and median functions with the onehundred_sequence object I created.
...
```{r}
#6
student_names <- c("Dorothy", "Blanch", "Rose", "Sophia")
student_names
#student_names is a character vector
test_scores <- c(98,81,77,80)
test_scores
#test_scores is a numeric vector
passed_gradeabovefifty <-c(TRUE, TRUE, TRUE, TRUE)
passed_gradeabovefifty
#passed_gradeabovefifty is a logical vector
