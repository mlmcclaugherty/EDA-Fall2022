...
print(O3plot2)
#we specified color=blue, but a blue plot is not generated--why? when you specify color inside the aesthetics, it thinks your adding another layer to the plot, not changing the color.
