...
#Actually intersect the counties (not just select those that intersect); chop off the parts of the counties that are outside of the Neuse River Basin (cookie cutter)
